...
export function Footer() {
  ...
  const productLinks = [
    ...
    { name: 'Analytics', href: '#', id: 'enhanced-dashboard' },
    { name: 'Reports', href: '#', id: 'reports' },
    { name: 'Calendar', href: '#', id: 'calendar' }
  ];

  const companyLinks = [
    { name: 'About Us', href: '#', id: 'dashboard' },
    { name: 'Academic Records', href: '#', id: 'semesters' },
    { name: 'Projects', href: '#', id: 'projects' },
    { name: 'Certificates', href: '#', id: 'certificates' }
  ];

  const supportLinks = [
    { name: 'Help Center', href: '#', id: 'support' },
    { name: 'Documentation', href: '#', id: 'support' },
    { name: 'Contact Support', href: '#', id: 'support' },
    { name: 'File Manager', href: '#', id: 'files' }
  ];

  const resourceLinks = [
    { name: 'Profile Settings', href: '#', id: 'profile' },
    { name: 'Academic Guides', href: '#', id: 'support' },
    { name: 'Data Export', href: '#', id: 'reports' },
    { name: 'Study Resources', href: '#', id: 'subjects' }
  ];
